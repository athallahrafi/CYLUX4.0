...
const char* WIFI_SSID     = "Garasi kost_4G";
const char* WIFI_PASSWORD = "123garasi123";

const char* MQTT_HOST = "1e4106c3c7bd441aa917e59c5fad8110.s1.eu.hivemq.cloud"; 
const int   MQTT_PORT = 8883; // Port 8883 WAJIB menggunakan SSL/TLS
const char* MQTT_USER = "cylux_main";              
const char* MQTT_PASS = "pastiJuara1";

const char* DEVICE_ID   = "esp32-gw-01"; 
...
void setup() {
  ...
  // [DITAMBAHKAN] Abaikan verifikasi sertifikat CA untuk menyederhanakan kode
  // Sangat berguna untuk tahap pengembangan/kompetisi.
...
void loop() {
  ...
  // Teruskan data telemetry dari Arduino Nano ke MQTT
  if (Serial.available()) {
